--  ----------------------------------------------------------------------------------------------------
--  PTPSync Data Structures for SQL Server - Gbtc
--
...
--       Script is based on PTPSync.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [PTPSync];
GO
ALTER DATABASE [PTPSync] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [PTPSync] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [PTPSync] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [PTPSync] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [PTPSync] SET ARITHABORT OFF 
GO
ALTER DATABASE [PTPSync] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [PTPSync] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [PTPSync] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [PTPSync] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [PTPSync] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [PTPSync] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [PTPSync] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [PTPSync] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [PTPSync] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [PTPSync] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [PTPSync] SET  ENABLE_BROKER 
GO
ALTER DATABASE [PTPSync] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [PTPSync] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [PTPSync] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [PTPSync] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [PTPSync] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [PTPSync] SET  READ_WRITE 
GO
ALTER DATABASE [PTPSync] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [PTPSync] SET  MULTI_USER 
GO
ALTER DATABASE [PTPSync] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [PTPSync] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the PTPSync database.
...
--GO
--CREATE ROLE [PTPSyncManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'PTPSyncManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'PTPSyncManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'PTPSyncManagerRole'
--GO
...
SELECT     dbo.Device.CompanyID, dbo.Company.Acronym AS CompanyAcronym, dbo.Company.Name AS CompanyName, dbo.Measurement.SignalID, 
                      ...
                      dbo.Measurement.PhasorSourceIndex, dbo.Phasor.Label AS PhasorLabel, dbo.Phasor.Type AS PhasorType, dbo.Phasor.Phase, dbo.Phasor.BaseKV,
