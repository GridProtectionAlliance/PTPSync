...
-- INSERT INTO OutputStream(NodeID, Acronym, Name, Type, ConnectionString, DataChannel, CommandChannel, IDCode, AutoPublishConfigFrame, AutoStartDataChannel, NominalFrequency, FramesPerSecond, LagTime, LeadTime, UseLocalClockAsRealTime, AllowSortsByArrival, LoadOrder, Enabled) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 'TESTSTREAM', 'Test Stream', 0, '', 'Port=-1;Clients=localhost:8800', 'Port=8900', 235, 0, 1, 60, 30, 0.001, 2, 0, 1, 0, 1)
-- GO

-- INSERT INTO OutputStreamDevice(NodeID, AdapterID, IDCode, Acronym, BpaAcronym, Name, LoadOrder, Enabled) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 2, 'TESTDEVICE', 'TEST', 'Test Device', 0, 1)
-- GO

-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 1, 'TESTDEVICE-SF')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 2, 'TESTDEVICE-FQ')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 3, 'TESTDEVICE-DV1')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 4, 'TESTDEVICE-DF')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 5, 'TESTDEVICE-PM1')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 6, 'TESTDEVICE-PA1')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 7, 'TESTDEVICE-PM2')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 8, 'TESTDEVICE-PA2')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 9, 'TESTDEVICE-PM3')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 10, 'TESTDEVICE-PA3')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 11, 'TESTDEVICE-PM4')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 12, 'TESTDEVICE-PA4')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 13, 'TESTDEVICE-PM5')
-- GO
-- INSERT INTO OutputStreamMeasurement(NodeID, AdapterID, HistorianID, PointID, SignalReference) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 1, 14, 'TESTDEVICE-PA5')
-- GO

-- INSERT INTO OutputStreamDevicePhasor(NodeID, OutputStreamDeviceID, Label, Type, Phase, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, '500 kV Bus 1', 'V', '+', 0)
-- GO
-- INSERT INTO OutputStreamDevicePhasor(NodeID, OutputStreamDeviceID, Label, Type, Phase, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, '500 kV Bus 2', 'V', '+', 1)
-- GO
-- INSERT INTO OutputStreamDevicePhasor(NodeID, OutputStreamDeviceID, Label, Type, Phase, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 'Cordova', 'I', '+', 2)
-- GO
-- INSERT INTO OutputStreamDevicePhasor(NodeID, OutputStreamDeviceID, Label, Type, Phase, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 'Dell', 'I', '+', 3)
-- GO
-- INSERT INTO OutputStreamDevicePhasor(NodeID, OutputStreamDeviceID, Label, Type, Phase, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 'Lagoon Creek', 'I', '+', 4)
-- GO

-- INSERT INTO OutputStreamDeviceDigital(NodeID, OutputStreamDeviceID, Label, LoadOrder) VALUES('facd14d5-56b5-4f63-a8d8-56e830bf6f7c', 1, 'Digital1', 0)
-- GO

INSERT INTO ApplicationRole (Name, Description, NodeID) VALUES ('Administrator', 'Administrator Role', 'facd14d5-56b5-4f63-a8d8-56e830bf6f7c')
GO
INSERT INTO ApplicationRole (Name, Description, NodeID) VALUES ('Editor', 'Editor Role', 'facd14d5-56b5-4f63-a8d8-56e830bf6f7c')
GO
INSERT INTO ApplicationRole (Name, Description, NodeID) VALUES ('Viewer', 'Viewer Role', 'facd14d5-56b5-4f63-a8d8-56e830bf6f7c')
GO