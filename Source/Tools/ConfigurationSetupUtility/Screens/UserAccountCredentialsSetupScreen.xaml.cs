...
namespace ConfigurationSetupUtility.Screens
{
    ...
    public partial class UserAccountCredentialsSetupScreen : UserControl, IScreen
    {
        ...
        public bool UserInputIsValid
        {
            get
            {
                if (!CheckCurrentUserAuthentication())
                {
                    ...
                    {
                        // Define default values for database passwords, but attempt to load custom settings from PTPSync or manager config files
                        ...
                        // Attempt to use the PTPSync config file first
                        ...
                        {
                            // Attempt to use the PTPSync Manager config file second
        ...
        private void RadioButtonWindowsAuthentication_Checked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please enter current credentials for the Windows authenticated user setup to be the administrator for PTPSync. Credentials validated by operating system.";
        ...
        private void RadioButtonWindowsAuthentication_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please provide the desired credentials for database user setup to be the administrator for PTPSync. Password complexity rules apply.";
