--  ----------------------------------------------------------------------------------------------------
--  PTPSync Data Structures for Oracle - Gbtc
--
...
-- CREATE TABLESPACE PTPSync_TS DATAFILE 'PTPSync.dbf' SIZE 20M AUTOEXTEND ON;
-- CREATE TABLESPACE PTPSync_INDEX DATAFILE 'PTPSync_index.dbf' SIZE 20M AUTOEXTEND ON;
-- CREATE USER PTPSync IDENTIFIED BY MyPassword DEFAULT TABLESPACE PTPSync_TS;
-- GRANT UNLIMITED TABLESPACE TO PTPSync;
-- GRANT CREATE SESSION TO PTPSync;
-- ALTER SESSION SET CURRENT_SCHEMA = PTPSync;
...
CREATE UNIQUE INDEX IX_ErrorLog_ID ON ErrorLog (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Runtime_Source ON Runtime (SourceID ASC, SourceTable ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Runtime_ID ON Runtime (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Company_ID ON Company (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_TrackedChange_ID ON TrackedChange (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Vendor_ID ON Vendor (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Protocol_ID ON Protocol (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_SignalType_ID ON SignalType (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Interconnection_ID ON Interconnection (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Node_ID ON Node (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Node_Name ON Node (Name ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OtherDevice_ID ON OtherDevice (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Device_ID ON Device (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Device_UniqueID ON Device (UniqueID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Device_NodeID_Acronym ON Device (NodeID ASC, Acronym ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_VendorDevice_ID ON VendorDevice (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevDigital_ID ON OutputStreamDeviceDigital (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevPhasor ON OutputStreamDevicePhasor (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutStreamDevAnalog ON OutputStreamDeviceAnalog (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Measurement_SignalID ON Measurement (SignalID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Measurement_PointID ON Measurement (PointID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Statistic_ID ON Statistic (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Statistic_Source_SigIndex ON Statistic (Source ASC, SignalIndex ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStreamMeasurement_ID ON OutputStreamMeasurement (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStreamDevice_ID ON OutputStreamDevice (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Phasor_ID ON Phasor (ID ASC) TABLESPACE PTPSync_INDEX;
CREATE UNIQUE INDEX IX_Phasor_DeviceID_SrcIndex ON Phasor (DeviceID ASC, SourceIndex ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_CalculatedMeasurement_ID ON CalculatedMeasurement (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_CustomActionAdapter_ID ON CustomActionAdapter (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Historian_ID ON Historian (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_CustomInputAdapter ON CustomInputAdapter (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_CustomFilterAdapter ON CustomFilterAdapter (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_OutputStream_ID ON OutputStream (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_OutputStream_NodeID_Acronym ON OutputStream (NodeID ASC, Acronym ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_PowerCalculation_ID ON PowerCalculation (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Alarm_ID ON Alarm (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_AlarmLog_ID ON AlarmLog (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_CustomOutputAdapter_ID ON CustomOutputAdapter (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_AccessLog_ID ON AccessLog (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_UserAccount_ID ON UserAccount (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_UserAccount_Name ON UserAccount (Name ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_SecurityGroup_ID ON SecurityGroup (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_SecurityGroup_Name ON SecurityGroup (Name ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_ApplicationRole_ID ON ApplicationRole (ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_ApplicationRole_NodeID_Name ON ApplicationRole (NodeID ASC, Name ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_Subscriber_NodeID_ID ON Subscriber (NodeID ASC, ID ASC) TABLESPACE PTPSync_INDEX;

CREATE UNIQUE INDEX IX_Subscriber_NodeID_Acronym ON Subscriber (NodeID ASC, Acronym ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_SubscriberMeasurement ON SubscriberMeasurement (NodeID ASC, SubscriberID ASC, SignalID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_SubscriberMeasurementGroup ON SubscriberMeasurementGroup (NodeID ASC, SubscriberID ASC, MeasurementGroupID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_MeasurementGroup_ID ON MeasurementGroup (ID ASC) TABLESPACE PTPSync_INDEX;
...
CREATE UNIQUE INDEX IX_MeasurementGroupMeasurement ON MeasurementGroupMeasurement (NodeID ASC, MeasurementGroupID ASC, SignalID ASC) TABLESPACE PTPSync_INDEX;
