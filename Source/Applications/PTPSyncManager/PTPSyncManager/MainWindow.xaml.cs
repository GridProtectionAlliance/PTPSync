        ...
        private void ButtonHelp_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (useLocalHelp)
            {
                try
                {
                    ...
                    string helpfile = FilePath.GetAbsolutePath("PTPSyncManagerHelp.mht");

                    if (File.Exists(helpfile))
                        Process.Start(helpfile);
                    else
                        MessageBox.Show("Local help file \"" + helpfile + "\" was not found", "PTPSync Manager Help", MessageBoxButton.OK, MessageBoxImage.Warning);
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Failed to launch local help file." + Environment.NewLine + ex.Message, "PTPSync Manager Help", MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
