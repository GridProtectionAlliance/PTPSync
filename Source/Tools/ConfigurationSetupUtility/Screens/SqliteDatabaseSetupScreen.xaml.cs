    ...
    public partial class SqliteDatabaseSetupScreen : UserControl, IScreen
    {
        ...
        private void InitializeState()
        {
            ...
            try
            {
                ...
                // *** For the PTPSync, we default this to ConfigurationCache folder so that DFS replication can be simple ***
                ...
                //string sqliteDatabaseFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "PTPSync\\");
                ...
                m_sqliteDatabaseFilePathTextBox.Text = Path.Combine(sqliteDatabaseFilePath, migrate ? App.SqliteConfigv2 : App.BaseSqliteConfig); //"PTPSync" + App.DatabaseVersionSuffix + ".db" : "PTPSync.db");
            }
            catch
            {
                m_sqliteDatabaseFilePathTextBox.Text = migrate ? App.SqliteConfigv2 : App.BaseSqliteConfig; //"PTPSync" + App.DatabaseVersionSuffix + ".db" : "PTPSync.db";
            }
